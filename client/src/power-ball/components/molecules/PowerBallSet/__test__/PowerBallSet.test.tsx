...
import PowerBallSet from '../PowerBallSet';
...
describe('PowerBallSet', () => {
  ...
  it('renders all numbers correctly', () => {
    render(<PowerBallSet whiteNumbers={[1, 2, 3, 4, 5]} powerball={10} setNumber={1} />);
  ...
  it('shows correct set number', () => {
    render(<PowerBallSet whiteNumbers={[1, 2, 3, 4, 5]} powerball={10} setNumber={3} />);
