...
import SearchResult from '@/lotto/components/organisms/SearchResult/SearchResult';
import PopularNumbersResult from '@/lotto/components/organisms/PopularNumbersResult/PopularNumbersResult';
import useSearchNumber from '@/lotto/hooks/searchNumberHook/useSearchNumber';
import Loading from '../atoms/Loading/Loading';
import VirtualizedSelect from '../molecules/VirtualizedSelect/VirtualizedSelect';
import popularNumberHook from '@/lotto/hooks/PopularNumberHook/usePopularNumberHook';
