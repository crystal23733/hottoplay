...
import NumberGrid from '@/lotto/components/organisms/NumberGrid/NumberGrid';
import LottoResult from '@/lotto/components/organisms/LottoResult/LottoResult';
...
import GenerationMethodInfo from '@/lotto/components/molecules/GenerationMethodInfo/GenerationMethodInfo';
import StatisticsOptions from '@/lotto/components/molecules/StatisticsOptions/StatisticsOptions';
import { StatisticsType } from '@/lotto/components/molecules/StatisticsOptions/StatisticsOptions.types';
import { PatternType } from '@/lotto/components/molecules/PatternOptions/PatternOptions.types';
import PatternOptions from '@/lotto/components/molecules/PatternOptions/PatternOptions';
