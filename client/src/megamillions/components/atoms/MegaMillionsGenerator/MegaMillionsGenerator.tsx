...
import MegaMillionsGeneratorProps from './MegaMillionsGenerator.types';

/**
 * 메가밀리언스 번호 생성기 컴포넌트
 * @param {MegaMillionsGeneratorProps} props - 메가밀리언스 번호 생성기 컴포넌트 속성
 * @returns {React.ReactNode} 메가밀리언스 번호 생성기 컴포넌트
 * @example
