...
import useMegaMillionsStatistics from '@/megamillions/hooks/useMegaMillionsStatistics';

/**
 * 메가밀리언스 통계 컴포넌트
 * @returns 메가밀리언스 통계 컴포넌트
 * @example
 * <MegaMillionsStatistics />
 */
const MegaMillionsStatistics = () => {
  const { selectedNumbers, data, loading, error, handleNumberSelect } = useMegaMillionsStatistics();
...
export default MegaMillionsStatistics;
