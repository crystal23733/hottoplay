...
import MegaMillionsFrequency from '../MegaMillionsFrequency';
import { NumberFrequencyResponse } from '@/api/megamillions/megaMillionsDraw.types';

// 훅 모킹
jest.mock('@/megamillions/hooks/useMegaMillionsNumberFrequency');
...
describe('PowerBallFrequency 컴포넌트', () => {
  ...
  it('로딩 상태일 때 새로고침 버튼이 비활성화되어야 합니다', () => {
    (useMegaMillionsNumberFrequency as jest.Mock).mockReturnValue({
      data: null,
      loading: true,
      error: null,
